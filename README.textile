...
This code was last updated on *01/03/14*.
...
* The zoom at which spiderfication occurs is controlled externally (e.g. by only calling @spiderListener(marker)@ when @getCameraPosition().zoom >= SPIDERFICATION_ZOOM_THRSH@).
